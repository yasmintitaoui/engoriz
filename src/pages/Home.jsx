      ...
      <section className="relative h-[100svh] overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center justify-end px-6 md:px-12">
          <div className="max-w-xl text-left">
            ...
            <motion.h1
              {...reveal(0.2)}
              className="mt-5 font-display text-[clamp(3.2rem,7vw,6.2rem)] uppercase leading-[0.9] tracking-[-0.03em]"
            >
            ...
            >
              ...
              <Link
                to="/shop"
                className="rounded-full border border-white px-7 py-4 text-[11px] uppercase tracking-[0.28em] transition hover:text-black"
              >
                {t('home.viewAll')}
              </Link>
            </motion.div>
